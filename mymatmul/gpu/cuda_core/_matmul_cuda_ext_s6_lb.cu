...
/*
 * Stage 6 LB: s6 with two-arg __launch_bounds__(NW*32, LB_MIN_BLOCKS).
 *
 * Compiled with -DLB_MIN_BLOCKS=N (N=1..4) to generate cubins with different
 * register budgets: floor(65536 / (NW*32 * LB_MIN_BLOCKS)) regs/thread.
 */
