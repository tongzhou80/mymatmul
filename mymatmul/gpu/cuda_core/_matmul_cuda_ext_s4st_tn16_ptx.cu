...
__device__ __forceinline__ void matmul_s4st_tn16_ptx_impl(
...
extern "C" __global__ void NAME(                                            \
    ...
    matmul_s4st_tn16_ptx_impl<BM, BN, BK, TM, TN, UNROLL>(A, B, C, M, K, N); \
}

//                NAME                                                BM   BN  BK TM  TN  U
MAKE_LAUNCHER(matmul_cuda_s4st_tn16_ptx_tm8_tn16_bm128_bn256_bk16_u1,  128,256,16, 8,16, 1)
MAKE_LAUNCHER(matmul_cuda_s4st_tn16_ptx_tm8_tn16_bm128_bn256_bk16_u2,  128,256,16, 8,16, 2)
MAKE_LAUNCHER(matmul_cuda_s4st_tn16_ptx_tm8_tn16_bm128_bn256_bk16_u4,  128,256,16, 8,16, 4)
MAKE_LAUNCHER(matmul_cuda_s4st_tn16_ptx_tm8_tn16_bm128_bn256_bk16_u8,  128,256,16, 8,16, 8)
MAKE_LAUNCHER(matmul_cuda_s4st_tn16_ptx_tm8_tn16_bm128_bn256_bk16_u16, 128,256,16, 8,16,16)
