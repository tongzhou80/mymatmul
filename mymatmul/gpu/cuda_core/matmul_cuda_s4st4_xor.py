"""s4st4_xor: float4 B reads + 8×4 warp layout + XOR swizzle on A (zero bank conflicts)."""

import re
from .._pycuda_loader import launch_matmul

_EXT = "_matmul_cuda_ext_s4st4_xor"
...
for _u in [1, 4, 8, 16]:
    _name = f"matmul_cuda_s4st4_xor_tm8_tn8_bm128_bn128_bk16_u{_u}"
