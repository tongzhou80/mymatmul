"""Stage 4 Strided-2 (s4st2): s4st with 2-contiguous output assignment for float2 B loads."""

import re
from .._pycuda_loader import launch_matmul

_EXT = "_matmul_cuda_ext_s4st2"
...
for _u in [1, 4, 8, 16]:
    _name = f"matmul_cuda_s4st2_tm8_tn8_bm128_bn128_bk16_u{_u}"
