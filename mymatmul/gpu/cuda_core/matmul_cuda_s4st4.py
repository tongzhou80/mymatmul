"""s4st4: float4 B reads + 8×4 warp layout, no A swizzle (2-way A bank conflict)."""

import re
from .._pycuda_loader import launch_matmul

_EXT = "_matmul_cuda_ext_s4st4"
...
for _u in [1, 4, 8, 16]:
    _name = f"matmul_cuda_s4st4_tm8_tn8_bm128_bn128_bk16_u{_u}"
