"""s4st_tn16_f2: TN=16 with float2 B smem loads; u1=168 regs, u2/u4=255 regs."""

from .._pycuda_loader import launch_matmul

_EXT = "_matmul_cuda_ext_s4st_tn16_f2"
...
for _u in [1, 2, 4, 8, 16]:
    _name = f"matmul_cuda_s4st_tn16_f2_tm8_tn16_bm128_bn256_bk16_u{_u}"
