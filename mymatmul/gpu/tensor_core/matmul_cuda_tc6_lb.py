"""TC6_lb: TC5_lb with ldmatrix_x4_trans for B, autotuned with register-estimate pruning.
...
_TC6_LB_CU = os.path.join(_GPU_DIR, "_matmul_cuda_ext_tc6_lb.cu")
_SM_ARCH   = "sm_89"
...
def _get_mod(lb):
    return get_module_jit(_TC6_LB_CU, _cubin_path(lb), [f"-DLB_MIN_BLOCKS={lb}"])
