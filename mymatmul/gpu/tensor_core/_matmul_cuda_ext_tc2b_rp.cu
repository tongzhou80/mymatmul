...
/*
 * TC2b_rp: TC2b + register prefetch on the inner kk loop.
 *
...
__device__ __forceinline__ void matmul_tc2b_rp_impl(
...
void matmul_cuda_tc2b_rp_bm##BM_##_bn##BN_##_bk##BK_##_nw##NW_(                        \
    const __nv_bfloat16* __restrict__ A, const __nv_bfloat16* __restrict__ B,       \
    __nv_bfloat16* __restrict__ C, int M, int K, int N) {                           \
    matmul_tc2b_rp_impl<BM_, BN_, BK_, NW_>(A, B, C, M, K, N);                         \
}
