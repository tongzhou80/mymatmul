#!/usr/bin/env python3
"""
NCU Speed-of-Light profiling for CUDA matmul kernels.

Pass CUDA kernel names directly; dotpath and dtype are inferred via _all_impls().

Usage
-----
    sudo -E env PATH="$PATH" PYTHONPATH="$PYTHONPATH" python3 profile_ncu_sol.py \\
        matmul_cuda_tc1_bm256_bn64_bk32_nw4 --size 4096

    sudo ... python3 profile_ncu_sol.py \\
        matmul_cuda_tc1_bm256_bn64_bk32_nw4 matmul_cuda_s6_bm256_bn64_bk32_nw4 --size 4096

    sudo ... python3 profile_ncu_sol.py matmul_cuda_tc1_bm256_bn64_bk32_nw4 --out results_sol.csv
"""
