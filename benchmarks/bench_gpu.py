...
IMPLEMENTATIONS = {
    ...
    **{f"s4st2_tn16_bm128_bn256_bk16_u{u}": (f"mymatmul.gpu.cuda_core.matmul_cuda_s4st2_tn16.matmul_s4st2_tn16_tm8_tn16_bm128_bn256_bk16_u{u}", None)
    ...
    # h2_s7 explorations (each tweaks a single aspect of h2_s7):
    "h2_s7_tma":       ("mymatmul.gpu.hopper.matmul_h2_s7_tma.matmul_h2_s7_tma",             None, torch.bfloat16),
    "h2_s7_desc":      ("mymatmul.gpu.hopper.matmul_h2_s7_desc.matmul_h2_s7_desc",           None, torch.bfloat16),
    "h2_s7_smem_epi":  ("mymatmul.gpu.hopper.matmul_h2_s7_smem_epi.matmul_h2_s7_smem_epi",   None, torch.bfloat16),
    "h2_s7_split":     ("mymatmul.gpu.hopper.matmul_h2_s7_split.matmul_h2_s7_split",         None, torch.bfloat16),
    ...
    "h2_s8_smem_epi":  ("mymatmul.gpu.hopper.matmul_h2_s8_smem_epi.matmul_h2_s8_smem_epi",   None, torch.bfloat16),
    ...
    "h2_s7_predesc":   ("mymatmul.gpu.hopper.matmul_h2_s7_predesc.matmul_h2_s7_predesc",     None, torch.bfloat16),
    "t1":              ("mymatmul.gpu.hopper.matmul_t1.matmul_t1",                           None, torch.bfloat16),
    "t3":              ("mymatmul.gpu.hopper.matmul_t3.matmul_t3",                           None, torch.bfloat16),
    "t4":              ("mymatmul.gpu.hopper.matmul_t4.matmul_t4",                           None, torch.bfloat16),
    "t5":              ("mymatmul.gpu.hopper.matmul_t5.matmul_t5",                           None, torch.bfloat16),
    "t6":              ("mymatmul.gpu.hopper.matmul_t6.matmul_t6",                           None, torch.bfloat16),
    "t7":              ("mymatmul.gpu.hopper.matmul_t7.matmul_t7",                           None, torch.bfloat16),
    "t8":              ("mymatmul.gpu.hopper.matmul_t8.matmul_t8",                           None, torch.bfloat16),
    "t9":              ("mymatmul.gpu.hopper.matmul_t9.matmul_t9",                           None, torch.bfloat16),
    "t10":             ("mymatmul.gpu.hopper.matmul_t10.matmul_t10",                         None, torch.bfloat16),
    "t11":             ("mymatmul.gpu.hopper.matmul_t11.matmul_t11",                         None, torch.bfloat16),
    "t12":             ("mymatmul.gpu.hopper.matmul_t12.matmul_t12",                         None, torch.bfloat16),
    "t13":             ("mymatmul.gpu.hopper.matmul_t13.matmul_t13",                         None, torch.bfloat16),
    "t14":             ("mymatmul.gpu.hopper.matmul_t14.matmul_t14",                         None, torch.bfloat16),
    "t15":             ("mymatmul.gpu.hopper.matmul_t15.matmul_t15",                         None, torch.bfloat16),
    "t16":             ("mymatmul.gpu.hopper.matmul_t16.matmul_t16",                         None, torch.bfloat16),
    "t17":             ("mymatmul.gpu.hopper.matmul_t17.matmul_t17",                         None, torch.bfloat16),
    "t18":             ("mymatmul.gpu.hopper.matmul_t18.matmul_t18",                         None, torch.bfloat16),
    "t19":             ("mymatmul.gpu.hopper.matmul_t19.matmul_t19",                         None, torch.bfloat16),
    "t20":             ("mymatmul.gpu.hopper.matmul_t20.matmul_t20",                         None, torch.bfloat16),
    "t21":             ("mymatmul.gpu.hopper.matmul_t21.matmul_t21",                         None, torch.bfloat16),
    "t22":             ("mymatmul.gpu.hopper.matmul_t22.matmul_t22",                         None, torch.bfloat16),
    "t23":             ("mymatmul.gpu.hopper.matmul_t23.matmul_t23",                         None, torch.bfloat16),
    "t24":             ("mymatmul.gpu.hopper.matmul_t24.matmul_t24",                         None, torch.bfloat16),
    "t25":             ("mymatmul.gpu.hopper.matmul_t25.matmul_t25",                         None, torch.bfloat16),
    "t26":             ("mymatmul.gpu.hopper.matmul_t26.matmul_t26",                         None, torch.bfloat16),
    "t27":             ("mymatmul.gpu.hopper.matmul_t27.matmul_t27",                         None, torch.bfloat16),
    "t28":             ("mymatmul.gpu.hopper.matmul_t28.matmul_t28",                         None, torch.bfloat16),
    "t29":             ("mymatmul.gpu.hopper.matmul_t29.matmul_t29",                         None, torch.bfloat16),
    "t30":             ("mymatmul.gpu.hopper.matmul_t30.matmul_t30",                         None, torch.bfloat16),
    "t31":             ("mymatmul.gpu.hopper.matmul_t31.matmul_t31",                         None, torch.bfloat16),
    "t32":             ("mymatmul.gpu.hopper.matmul_t32.matmul_t32",                         None, torch.bfloat16),
    "t33":             ("mymatmul.gpu.hopper.matmul_t33.matmul_t33",                         None, torch.bfloat16),
    "t34":             ("mymatmul.gpu.hopper.matmul_t34.matmul_t34",                         None, torch.bfloat16),
    "t35":             ("mymatmul.gpu.hopper.matmul_t35.matmul_t35",                         None, torch.bfloat16),
    "t36":             ("mymatmul.gpu.hopper.matmul_t36.matmul_t36",                         None, torch.bfloat16),
    # Hopper H4: __cluster_dims__ explorations
    "h4":          ("mymatmul.gpu.hopper.matmul_h4.matmul_h4",                   None, torch.bfloat16),
    "h4_shapes":   ("mymatmul.gpu.hopper.matmul_h4_shapes.matmul_h4_shapes",     None, torch.bfloat16),
